...
# def run_anonymize(qi_list, sa, data_file, hierarchy_file_dir, k=5): #####################
#     df = pd.read_csv(data_file, usecols=qi_list + sa) ####################################
# def run_anonymize(qi_list, sa, data_file, hierarchy_file_dir, k=5):
...
def anonymize_execute(k_value):
    ...
    data_frame = run_anonymize(qi_list, input_path, hierarchy_file_path, k)
    # output ####################################################################################
